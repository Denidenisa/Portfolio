    ...
    return <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
        ...
        <div className="flex-col hidden md:flex c-space">
            ...
            <div className="flex flex-col items-start">
                ...
                <motion.p className="text-4xl font-medium text-neutral-300" variants={variants} initial="hidden" animate="visible" transition={{delay:1.8}}>Expériences numériques </motion.p>
            </div>
        </div>
        {/*Mobile View */}
        <div className="flex- flex-col space-y-6 md:hidden">
            <motion.p className="text-4xl font-medium"variants={variants} initial="hidden" animate="visible" transition={{delay:1}}>Hi,c'est Denisa</motion.p>
            <div>
                ...
                <motion.p className="text-4xl font-black text-neutral300"variants={variants} initial="hidden" animate="visible" transition={{delay:1.8}}>le code </motion.p>
            </div>
        </div>
